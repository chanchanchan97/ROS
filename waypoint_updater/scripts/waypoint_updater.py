...
LOOKAHEAD_WPS = 7 # Number of waypoints we will publish. You can change this number
...
class WaypointUpdater(object):
    def __init__(self):
        ...
        rospy.Subscriber('/rear_pose', PoseStamped, self.pose_cb)
    ...
    def get_closest_waypoint_idx(self):
        ...
        print(self.waypoint_tree.query([x,y],1))
